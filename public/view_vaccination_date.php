            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card border-0 flex-fill w-100 shadow-lg" id="users">
                        ...
                        WHERE `status` = 'In Process' AND patient_id = '" . $_SESSION["uid"] . "'
                        LIMIT {$offset},{$limit}";
                                        ...
                                        <tbody class="list">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        <h6 class="text-light bg-warning d-inline px-3 py-1 rounded-3"><?php echo $row['status'] ?></h6>
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <ul class="pagination list-pagination mb-0">
                                    ...
                                    if (mysqli_num_rows($result1) > 0) {
                                        ...
                                        if ($page > 1) {
                                            echo '<li class="page-item"><a class="page-link border-0 rounded me-2" href="view_vaccination_date.php?page=' . ($page - 1) . '">Previous</a></li>';
                                        }
                                        ...
                                        for ($i = $startPage; $i <= $endPage; $i++) {
                                            ...
                                            echo '<li class="page-item ' . $active . '"><a class="page-link border-0 rounded px-4 me-2" href="view_vaccination_date.php?page=' . $i . '">' . $i . '</a></li>';
                                        }
                                        if ($total_page > $page) {
                                            echo '<li class="page-item"><a class="page-link border-0 rounded me-2" href="view_vaccination_date.php?page=' . ($page + 1) . '">Next</a></li>';
                                        }
                                        echo '</ul>';
                                    } else {
                                        echo '<h3 class="text-center h2">Your Status is Pending</h3>';
                                    }
