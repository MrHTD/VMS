                ...
                <div class="col">
                    ...
                    <div class="card border-0 flex-fill w-100 shadow-lg" id="users">
                        <div class="card-header border-0 card-header-space-between">
                            ...
                            <a href="add_hospital.php" class="btn btn-light text-uppercase">
                                Add Hospital
                            </a>
                                ...
                                ?>
                                    ...
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td class="text-wrap"><?php echo $row['H_Address'] ?></td>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <ul class="pagination list-pagination mb-0">
                                    ...
                                    if (mysqli_num_rows($result1) > 0) {
                                        ...
                                        if ($page > 1) {
                                            echo '<li class="page-item"><a class="page-link border-0 rounded me-2" href="admin_hospital.php?page=' . ($page - 1) . '">Previous</a></li>';
                                        }
                                        ...
                                        for ($i = $startPage; $i <= $endPage; $i++) {
                                            ...
                                            echo '<li class="page-item ' . $active . '"><a class="page-link border-0 rounded px-4 me-2" href="admin_hospital.php?page=' . $i . '">' . $i . '</a></li>';
                                        }
                                        if ($total_page > $page) {
                                            echo '<li class="page-item"><a class="page-link border-0 rounded me-2" href="admin_hospital.php?page=' . ($page + 1) . '">Next</a></li>';
                                        }
                                        echo '</ul>';
                                    } else {
